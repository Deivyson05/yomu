        ...
        <div className="pb-24 md:pb-8 mt-6">
            <div className="max-w-4xl mx-auto px-6 flex flex-col gap-4">
                ...
                <button
                    ...
                    className="w-full bg-blue-600 text-white py-4 px-6 rounded-xl font-bold text-lg shadow-lg hover:bg-blue-700 transition-all duration-300 active:scale-95 md:hover:scale-[1.02] flex items-center justify-center gap-2"
                >
                    <TrendingUp size={24} />
                    R. Progresso
                </button>
